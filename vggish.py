...
# weight path
WEIGHTS_PATH = './checkpoints/vggish_audioset_weights_without_fc2.h5'
WEIGHTS_PATH_TOP = './checkpoints/vggish_audioset_weights.h5'
...
def VGGish(load_weights=True, weights='audioset',
    ...
    if include_top:
        ...
        x = Dense(out_dim, activation='linear', name='vggish_fc2')(x)
    else:
        if pooling == 'avg':
